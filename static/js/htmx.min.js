(function (e, t) {
    ...
    return function () {
        ...
        function Lt() {
            ...
            if (W.config.historyEnabled) history.replaceState({htmx: true}, J().title, window.location.href);
        ...
        function Nt(a) {
            ...
            e.onload = function () {
                if (this.status >= 200 && this.status < 400) {
                    ...
                    At(r.tasks);
                    Et = a;
                    Q(J().body, "htmx:historyRestore", {path: a, cacheMiss: true, serverResponse: this.response})
                } else {
        ...
        function Ft(e, t) {
            if (e.willValidate) {
                ...
                if (!e.checkValidity()) {
                    ...
                    Q(e, "htmx:validation:failed", {message: e.validationMessage, validity: e.validity})
                }
            }
        }
        ...
        function Kt(e, t) {
            ...
            if (t.show) {
                ...
                if (t.show === "top" && (r || i)) {
                    i = i || r;
                    i.scrollIntoView({block: "start", behavior: W.config.scrollBehavior})
                }
        ...
        function lr(e, t, n, r, i, f) {
            ...
            if (!f) {
                ...
                var m = {target: g, elt: n, path: t, verb: e, triggeringEvent: r, etc: i, issueRequest: p};
            ...
            K(["loadstart", "loadend", "progress", "abort"], function (t) {
                K([o, o.upload], function (e) {
                    e.addEventListener(t, function (e) {
                        Q(n, "htmx:xhr:" + t, {lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total})
                    })
                })
            });
        ...
        function fr(s, l) {
                ...
                var o = function () {
                    try {
                        ...
                        if (t.elt && !te(t.elt) && t.elt.id) {
                            ...
                            var i = {preventScroll: c.focusScroll !== undefined ? !c.focusScroll : !W.config.defaultFocusScroll};
                            if (r) {
            ...
            if (t) {
                Y(s, "htmx:responseError", re({error: "Response Status Error Code " + u.status + " from " + l.pathInfo.requestPath}, l))
            }
        }
